...
var INIT_CODE_HASHES = (_INIT_CODE_HASHES = {}, _INIT_CODE_HASHES[ChainId.MAINNET] = INIT_CODE_HASH_ETH, _INIT_CODE_HASHES[ChainId.ROPSTEN] = INIT_CODE_HASH_ETH, _INIT_CODE_HASHES[ChainId.RINKEBY] = INIT_CODE_HASH_ETH, _INIT_CODE_HASHES[ChainId.GÖRLI] = INIT_CODE_HASH_ETH, _INIT_CODE_HASHES[ChainId.KOVAN] = INIT_CODE_HASH_ETH, _INIT_CODE_HASHES[ChainId.BSC_MAINNET] = INIT_CODE_HASH_BSC, _INIT_CODE_HASHES[ChainId.BSC_TESTNET] = INIT_CODE_HASH_BSC, _INIT_CODE_HASHES[ChainId.HECO_MAINNET] = INIT_CODE_HASH_HECO, _INIT_CODE_HASHES[ChainId.HECO_TESTNET] = INIT_CODE_HASH_MATIC, _INIT_CODE_HASHES[ChainId.MATIC_MAINNET] = INIT_CODE_HASH_MATIC, _INIT_CODE_HASHES);
...
var Pair = /*#__PURE__*/function () {
  ...
  Pair.getAddress = function getAddress(tokenA, tokenB) {
    ...
    if (((_PAIR_ADDRESS_CACHE = PAIR_ADDRESS_CACHE) === null || _PAIR_ADDRESS_CACHE === void 0 ? void 0 : (_PAIR_ADDRESS_CACHE$t = _PAIR_ADDRESS_CACHE[tokens[0].address]) === null || _PAIR_ADDRESS_CACHE$t === void 0 ? void 0 : _PAIR_ADDRESS_CACHE$t[tokens[1].address]) === undefined) {
      ...
      PAIR_ADDRESS_CACHE = _extends({}, PAIR_ADDRESS_CACHE, (_extends3 = {}, _extends3[tokens[0].address] = _extends({}, (_PAIR_ADDRESS_CACHE2 = PAIR_ADDRESS_CACHE) === null || _PAIR_ADDRESS_CACHE2 === void 0 ? void 0 : _PAIR_ADDRESS_CACHE2[tokens[0].address], (_extends2 = {}, _extends2[tokens[1].address] = getCreate2Address(FACTORY_ADDRESS, keccak256(['bytes'], [pack(['address', 'address'], [tokens[0].address, tokens[1].address])]), INIT_CODE_HASHES[tokenA.chainId]), _extends2)), _extends3));
    }
